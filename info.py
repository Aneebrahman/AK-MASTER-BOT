...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002075747729').split()]
...
DATABASE_NAME2 = environ.get('DATABASE_NAME2', "leoautofilter:leoautofilter")
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", '<b>{caption}</b>')
